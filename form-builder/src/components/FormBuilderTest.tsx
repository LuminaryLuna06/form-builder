...
//       name: page.name || `page_${uuidv4()}`,
//       title: page.title || "",
//       description: page.description || "",
//       elements:
//         page.elements?.map((element: any) => ({
//           id: element.id || uuidv4(),
//           name: element.name || `question_${uuidv4()}`,
//           type: element.type || "short_text",
//           title: element.title || "",
//           description: element.description || "",
//           options: element.options || [],
//           correctAnswers: element.correctAnswers || [],
//           score: element.score || 0,
//           ratingCharacter: element.ratingCharacter || "★",
//           ratingScale:
//             element.ratingScale || (element.type === "rating" ? 11 : 0),
